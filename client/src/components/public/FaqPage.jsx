  ...
  return (
    <div className="row">
      <div className="col-md-8 col-md-offset-2">
        ...
        <div className="panel-group faq-container" id="faqAccordion">
          <div className="panel panel-default">
            <div className="panel-heading accordion-toggle question-toggle collapsed" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question0">
               <h4 className="panel-title">Q: What is Lorem Ipsum{'?'}</h4>
            </div>
          ...
          <div className="panel panel-default">
            <div className="panel-heading accordion-toggle collapsed question-toggle" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question1">
               <h4 className="panel-title">Q: Why do we use it{'?'}</h4>
            </div>
            <div id="question1" className="panel-collapse collapse">
            <div className="panel-body">
                <h5><span className="label label-primary">Answer</span></h5>
          ...
          <div className="panel panel-default">
            <div className="panel-heading accordion-toggle collapsed question-toggle" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question2">
               <h4 className="panel-title">Q: Where does it come from {'?'}</h4>
            </div>
            <div id="question2" className="panel-collapse collapse">
              <div className="panel-body">
                <h5><span className="label label-primary">Answer</span></h5>
                <p>Contrary to popular belief, Lorem Ipsum is not simply random
                  ...
                  the word in classNameical literature, discovered the undoubtable
          ...
          <div className="panel panel-default">
            <div className="panel-heading accordion-toggle collapsed question-toggle" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question3">
             <h4 className="panel-title">Q: Where can I get some {'?'}</h4>
            </div>
            <div id="question3" className="panel-collapse collapse">
              <div className="panel-body">
                 <h5><span className="label label-primary">Answer</span></h5>
